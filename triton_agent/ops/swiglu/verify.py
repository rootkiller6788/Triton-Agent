"""SwiGLU: correctness verification against PyTorch reference."""
...
def verify_swiglu(triton_output: Any, ref_output: Any, contract: OpContract) -> CandidateResult:
    ...
    if not isinstance(triton_output, torch.Tensor):
        ...
        result.verify_log = "output is not a tensor"
        return result
