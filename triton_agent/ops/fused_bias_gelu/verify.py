"""Fused Bias GELU: correctness verification against PyTorch reference."""
...
def verify_fused_bias_gelu(
    triton_output: Any,
    ref_output: Any,
    contract: OpContract,
) -> CandidateResult:
    """Verify Triton Fused Bias GELU output against PyTorch reference."""
